...
const AdminMediaPanel = () => {
  ...
  if (loading) {
    return (
      <div className="p-8 flex items-center justify-center">
        <p className="text-muted-foreground">載入素材管理...</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      <h1 className="text-xl md:text-3xl font-bold">素材管理</h1>
                        ...
                        {isEditing ? (
                          <>
                            <div>
                              ...
                              <Input
                                value={edits.name}
                                onChange={(e) => setEditingProduct((prev) => ({ ...prev, [product.id]: { ...prev[product.id], name: e.target.value } }))}
                              />
                            </div>
                            <div>
                              ...
                              <Textarea
                                ...
                                onChange={(e) => setEditingProduct((prev) => ({ ...prev, [product.id]: { ...prev[product.id], description: e.target.value } }))}
                                rows={3}
                              />
                            </div>
                            <div className="flex gap-2">
                              ...
                              <Button size="sm" variant="outline" onClick={() => setEditingProduct((prev) => { const n = { ...prev }; delete n[product.id]; return n; })}>
                                取消
                              </Button>
                            </div>
                          </>
                          ...
                          <>
                            <p className="text-sm"><span className="font-medium">名稱：</span>{product.name || "（未設定）"}</p>
                            <p className="text-sm"><span className="font-medium">描述：</span>{product.description || "（未設定）"}</p>
